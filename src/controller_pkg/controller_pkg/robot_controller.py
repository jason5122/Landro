...
# prefix with package name to import without error
# https://stackoverflow.com/questions/57426715/import-modules-in-package-in-ros2
from controller_pkg.movement_logic import calculate_movement
...
class Controller(Node):
  ...
  def __init__(self):
    ...
    # subscribes to messages of type sensor_msgs/LaserScan
  ...
  def state_estimate_callback(self, msg):
    ...
    movement_msg = calculate_movement(self)
...
def main(args=None):
    ...
    controller.destroy_node()  # optional
    rclpy.shutdown()
